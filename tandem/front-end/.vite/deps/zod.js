...
import {
  ...
  Ar as $ZodPromise,
  At as _length,
  B as unknownProcessor,
  Bi as config,
  Bn as $ZodCIDRv4,
  Br as $ZodTuple,
  Bt as _multipleOf,
  C as objectProcessor,
  Ci as extend,
  Cn as _void$1,
  Cr as $ZodNullable,
  Ct as _ipv6,
  D as promiseProcessor,
  Di as mergeDefs,
  Dn as $input,
  Dr as $ZodOptional,
  Dt as _isoTime,
  E as prefaultProcessor,
  Ei as merge,
  En as meta$1,
  Er as $ZodObjectJIT,
  Et as _isoDuration,
  ...
  Fi as util_exports,
  Fn as $ZodBase64,
  Fr as $ZodStringFormat,
  Ft as _maxLength,
  G as _any,
  Gn as $ZodCodec,
  Gr as $ZodUndefined,
  Gt as _nonnegative,
  H as createStandardJSONSchemaMethod,
  Hn as $ZodCUID,
  Hr as $ZodULID,
  Ht as _nanoid,
  I as transformProcessor,
  Ii as $ZodEncodeError,
  In as $ZodBase64URL,
  Ir as $ZodSuccess,
  It as _maxSize,
  J as _base64url,
  ...
  Lr as $ZodSymbol,
  Lt as _mime,
  M as successProcessor,
  Mi as required,
  Mn as en_default,
  Mr as $ZodRecord,
  Mt as _lt,
  N as symbolProcessor,
  Ni as safeExtend,
  Nn as $ZodAny,
  Nr as $ZodSet,
  Nt as _lte,
  O as readonlyProcessor,
  Oi as normalizeParams,
  On as $output,
  Or as $ZodPipe,
  Ot as _jwt,
  P as templateLiteralProcessor,
  Pi as shallowClone,
  Pn as $ZodArray,
  Pr as $ZodString,
  Pt as _mac,
  ...
  Qr as domain,
  Qt as _property,
  R as undefinedProcessor,
  Ri as $constructor,
  Rn as $ZodBigIntFormat,
  Rr as $ZodTemplateLiteral,
  Rt as _minLength,
  S as numberProcessor,
  Si as defineLazy,
  Sn as _uuidv7,
  Sr as $ZodNull,
  St as _ipv4,
  T as pipeProcessor,
  Ti as jsonStringifyReplacer,
  Tn as describe$1,
  Tr as $ZodNumberFormat,
  Tt as _isoDateTime,
  U as createToJSONSchemaMethod,
  Un as $ZodCUID2,
  Ur as $ZodURL,
  Ut as _negative,
  V as voidProcessor,
  ...
  ci as _safeDecode,
  cn as _symbol,
  cr as $ZodISODateTime,
  ct as _e164,
  d as fileProcessor,
  di as _safeEncodeAsync,
  dn as _trim,
  dr as $ZodIntersection,
  dt as _endsWith,
  ei as hostname$1,
  en as _regex,
  er as $ZodEnum,
  et as _coercedBoolean,
  f as functionProcessor,
  fi as _safeParse,
  fn as _uint32,
  fr as $ZodJWT,
  ft as _file,
  ...
  gr as $ZodMAC,
  gt as _gte,
  h as literalProcessor,
  hn as _undefined$1,
  hr as $ZodLiteral,
  ht as _gt,
  i as bigintProcessor,
  ii as _encode,
  in as _string,
  ir as $ZodGUID,
  it as _cuid,
  j as stringProcessor,
  ji as pick,
  jn as locales_exports,
  jr as $ZodReadonly,
  jt as _lowercase,
  k as recordProcessor,
  ki as omit,
  kn as globalRegistry,
  kr as $ZodPrefault,
  kt as _ksuid,
  l as defaultProcessor,
  li as _safeDecodeAsync,
  ln as _toLowerCase,
  ...
  nn as _slugify,
  nr as $ZodFile,
  nt as _coercedNumber,
  o as catchProcessor,
  oi as _parse,
  on as _stringbool,
  or as $ZodIPv6,
  ot as _custom,
  p as intersectionProcessor,
  pi as _safeParseAsync,
  pn as _uint64,
  pr as $ZodKSUID,
  pt as _float32,
  q as _base64,
  qn as $ZodCustomStringFormat,
  qr as $ZodUnknown,
  qt as _normalize,
  r as arrayProcessor,
  ri as _decodeAsync,
  rn as _startsWith,
  rr as $ZodFunction,
  rt as _coercedString,
  s as customProcessor,
  si as _parseAsync,
  sn as _superRefine,
  sr as $ZodISODate,
  st as _date,
  t as core_exports,
  ti as regexes_exports,
  tn as _size,
  tr as $ZodExactOptional,
  tt as _coercedDate,
  u as enumProcessor,
  ui as _safeEncode,
  un as _toUpperCase,
  ...
  vr as $ZodNaN,
  vt as _includes,
  w as optionalProcessor,
  wi as issue,
  wn as _xid,
  wr as $ZodNumber,
  wt as _isoDate,
  x as nullableProcessor,
  xi as clone,
  xn as _uuidv6,
  xr as $ZodNonOptional,
  xt as _int64,
  y as nonoptionalProcessor,
  yi as prettifyError,
  yn as _uuid,
  yr as $ZodNanoID,
  yt as _int,
...
const ZodBoolean = /* @__PURE__ */ $constructor('ZodBoolean', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    booleanProcessor(inst, ctx, json$1, params);
});
...
const ZodUndefined = /* @__PURE__ */ $constructor('ZodUndefined', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    undefinedProcessor(inst, ctx, json$1, params);
});
...
const ZodUnknown = /* @__PURE__ */ $constructor('ZodUnknown', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    unknownProcessor(inst, ctx, json$1, params);
});
function unknown() {
...
const ZodIntersection = /* @__PURE__ */ $constructor('ZodIntersection', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    intersectionProcessor(inst, ctx, json$1, params);
});
...
const ZodLiteral = /* @__PURE__ */ $constructor('ZodLiteral', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    literalProcessor(inst, ctx, json$1, params);
...
const ZodTransform = /* @__PURE__ */ $constructor('ZodTransform', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    transformProcessor(inst, ctx, json$1, params);
...
const ZodOptional = /* @__PURE__ */ $constructor('ZodOptional', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    optionalProcessor(inst, ctx, json$1, params);
...
const ZodNullable = /* @__PURE__ */ $constructor('ZodNullable', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    nullableProcessor(inst, ctx, json$1, params);
  inst.unwrap = () => inst._zod.def.innerType;
});
...
const ZodDefault = /* @__PURE__ */ $constructor('ZodDefault', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    defaultProcessor(inst, ctx, json$1, params);
  inst.unwrap = () => inst._zod.def.innerType;
...
const ZodPrefault = /* @__PURE__ */ $constructor('ZodPrefault', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    prefaultProcessor(inst, ctx, json$1, params);
  inst.unwrap = () => inst._zod.def.innerType;
});
...
const ZodNonOptional = /* @__PURE__ */ $constructor('ZodNonOptional', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    nonoptionalProcessor(inst, ctx, json$1, params);
  inst.unwrap = () => inst._zod.def.innerType;
});
...
const ZodSuccess = /* @__PURE__ */ $constructor('ZodSuccess', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    successProcessor(inst, ctx, json$1, params);
  inst.unwrap = () => inst._zod.def.innerType;
});
...
const ZodReadonly = /* @__PURE__ */ $constructor('ZodReadonly', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    readonlyProcessor(inst, ctx, json$1, params);
  inst.unwrap = () => inst._zod.def.innerType;
});
...
const ZodTemplateLiteral = /* @__PURE__ */ $constructor('ZodTemplateLiteral', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    templateLiteralProcessor(inst, ctx, json$1, params);
});
...
const ZodPromise = /* @__PURE__ */ $constructor('ZodPromise', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    promiseProcessor(inst, ctx, json$1, params);
  inst.unwrap = () => inst._zod.def.innerType;
});
...
const ZodFunction = /* @__PURE__ */ $constructor('ZodFunction', (inst, def) => {
  ...
  ZodType.init(inst, def);
  inst._zod.processJSONSchema = (ctx, json$1, params) =>
    functionProcessor(inst, ctx, json$1, params);
});
...
function convertSchema(schema, ctx) {
  ...
  for (const key of ['contentEncoding', 'contentMediaType', 'contentSchema'])
    if (key in schema) extraMeta[key] = schema[key];
  for (const key of Object.keys(schema))
    if (!RECOGNIZED_KEYS.has(key)) extraMeta[key] = schema[key];

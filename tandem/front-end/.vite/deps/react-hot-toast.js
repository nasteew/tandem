...
var e = { data: '' },
  t = (t$1) => {
    if ('object' == typeof window) {
      let e$1 =
        (t$1 ? t$1.querySelector('#_goober') : window._goober) ||
        Object.assign(document.createElement('style'), {
          innerHTML: ' ',
          id: '_goober',
        });
      return (
        (e$1.nonce = window.__nonce__),
        e$1.parentNode || (t$1 || document.head).appendChild(e$1),
        e$1.firstChild
      );
    }
    return t$1 || e;
    ...
    for (let n$2 in e$1) {
      ...
      '@' == n$2[0]
        ? 'i' == n$2[1]
          ? (r$1 = n$2 + ' ' + c$1 + ';')
          : (l$1 +=
              'f' == n$2[1] ? o(c$1, n$2) : n$2 + '{' + o(c$1, 'k' == n$2[1] ? '' : t$1) + '}')
        : 'object' == typeof c$1
          ? (l$1 += o(
              c$1,
              t$1
                ? t$1.replace(/([^,])+/g, (e$2) =>
                    n$2.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g, (t$2) =>
                      /&/.test(t$2) ? t$2.replace(/&/g, e$2) : e$2 ? e$2 + ' ' + t$2 : t$2
                    )
                  )
                : n$2
            ))
          : null != c$1 &&
            ((n$2 = /^--/.test(n$2) ? n$2 : n$2.replace(/[A-Z]/g, '-$&').toLowerCase()),
            (a$1 += o.p ? o.p(n$2, c$1) : n$2 + ':' + c$1 + ';'));
    }
  ...
  i = (e$1, t$1, r$1, i$1, p$1) => {
        ...
        u$1 !== e$1
          ...
          : ((e$2) => {
              let t$3,
                r$2,
                o$1 = [{}];
              for (; (t$3 = l.exec(e$2.replace(a, ''))); )
                t$3[4]
                  ? o$1.shift()
                  : t$3[3]
                    ? ((r$2 = t$3[3].replace(n$1, ' ').trim()),
                      o$1.unshift((o$1[0][r$2] = o$1[0][r$2] || {})))
                    : (o$1[0][t$3[1]] = t$3[2].replace(n$1, ' ').trim());
              return o$1[0];
            })(e$1);
    ...
    return (
      ...
      ((e$2, t$2, r$2, l$1) => {
        l$1
          ? (t$2.data = t$2.data.replace(l$1, e$2))
          : -1 === t$2.data.indexOf(e$2) && (t$2.data = r$2 ? e$2 + t$2.data : t$2.data + e$2);
      })(c[d$1], t$1, i$1, f$2),
      d$1
    );
  },
  p = (e$1, t$1, r$1) =>
    e$1.reduce((e$2, l$1, a$1) => {
      let n$2 = t$1[a$1];
      if (n$2 && n$2.call) {
        let e$3 = n$2(r$1),
          t$2 = (e$3 && e$3.props && e$3.props.className) || (/^go/.test(e$3) && e$3);
        n$2 = t$2
          ? '.' + t$2
          : e$3 && 'object' == typeof e$3
            ? e$3.props
              ? ''
              : o(e$3, '')
            : !1 === e$3
...
function u(e$1) {
  let r$1 = this || {},
    l$1 = e$1.call ? e$1(r$1.p) : e$1;
  return i(
    l$1.unshift
      ? l$1.raw
        ? p(l$1, [].slice.call(arguments, 1), r$1.p)
        : l$1.reduce((e$2, t$1) => Object.assign(e$2, t$1 && t$1.call ? t$1(r$1.p) : t$1), {})
      : l$1,
    t(r$1.target),
    r$1.g,
    r$1.o,
...
function w$1(e$1, t$1) {
  ...
  return function () {
    ...
    function a$1(n$2, o$1) {
      let c$1 = Object.assign({}, n$2),
        s$1 = c$1.className || a$1.className;
      ((r$1.p = Object.assign({ theme: f$1 && f$1() }, c$1)),
        (r$1.o = / *go\d+/.test(s$1)),
        (c$1.className = u.apply(r$1, l$1) + (s$1 ? ' ' + s$1 : '')),
        t$1 && (c$1.ref = o$1));
      let i$1 = e$1;
...
var Z = (e$1) => typeof e$1 == 'function',
  h = (e$1, t$1) => (Z(e$1) ? e$1(t$1) : e$1);
var W = (() => {
    let e$1 = 0;
    return () => (++e$1).toString();
  })(),
...
var H = (e$1, t$1) => {
  ...
  _ = (e$1) => Object.keys(f).forEach((t$1) => Y(e$1, t$1)),
  Q = (e$1) => Object.keys(f).find((t$1) => f[t$1].toasts.some((o$1) => o$1.id === e$1)),
  S =
    (e$1 = k) =>
    (t$1) => {
      Y(t$1, e$1);
  ...
  V = (e$1 = {}, t$1 = k) => {
    let [o$1, s$1] = (0, import_react.useState)(f[t$1] || j),
      a$1 = (0, import_react.useRef)(f[t$1]);
    (0, import_react.useEffect)(
      () => (
        a$1.current !== f[t$1] && s$1(f[t$1]),
        v.push([t$1, s$1]),
        () => {
    ...
    let i$1 = o$1.toasts.map((r$1) => {
      ...
      return {
        ...
        removeDelay:
          r$1.removeDelay ||
          ((l$1 = e$1[r$1.type]) == null ? void 0 : l$1.removeDelay) ||
          (e$1 == null ? void 0 : e$1.removeDelay),
        duration:
          r$1.duration ||
          ((g$1 = e$1[r$1.type]) == null ? void 0 : g$1.duration) ||
          (e$1 == null ? void 0 : e$1.duration) ||
          se[r$1.type],
        style: {
          ...e$1.style,
...
var ce = 1e3,
  w = (e$1, t$1 = 'default') => {
    let { toasts: o$1, pausedAt: s$1 } = V(e$1, t$1),
      a$1 = (0, import_react.useRef)(/* @__PURE__ */ new Map()).current,
      i$1 = (0, import_react.useCallback)((c$1, m$1 = ce) => {
    ...
    let r$1 = (0, import_react.useCallback)(S(t$1), [t$1]),
      l$1 = (0, import_react.useCallback)(() => {
        r$1({
          type: 5,
          time: Date.now(),
        });
      }, [r$1]),
      g$1 = (0, import_react.useCallback)(
        (c$1, m$1) => {
          r$1({
            type: 1,
            toast: {
      ...
      d$1 = (0, import_react.useCallback)(
        (c$1, m$1) => {
          let { reverseOrder: p$1 = !1, gutter: R = 8, defaultPosition: z } = m$1 || {},
            O = o$1.filter((u$1) => (u$1.position || z) === (c$1.position || z) && u$1.height),
            K = O.findIndex((u$1) => u$1.id === c$1.id),
            B = O.filter((u$1, I) => I < K && u$1.visible).length;
          return O.filter((u$1) => u$1.visible)
            .slice(...(p$1 ? [B + 1] : [0, B]))
            .reduce((u$1, I) => u$1 + (I.height || 0) + R, 0);
        },
        [o$1]
      );
    return (
...
`,
  $ = ({ toast: e$1 }) => {
    ...
    return t$1 !== void 0
      ? typeof t$1 == 'string'
        ? import_react.createElement(Pe, null, t$1)
        : t$1
      : o$1 === 'blank'
        ? null
        : import_react.createElement(
            Se,
            null,
            import_react.createElement(F, { ...s$1 }),
            o$1 !== 'loading' &&
              import_react.createElement(
                be,
                null,
                o$1 === 'error'
                  ? import_react.createElement(C, { ...s$1 })
                  : import_react.createElement(L, { ...s$1 })
              )
          );
  };
var Re = (e$1) => `
...
`,
  ke = (e$1, t$1) => {
    let s$1 = e$1.includes('top') ? 1 : -1,
      [a$1, i$1] = E() ? [ve, De] : [Re(s$1), Ee(s$1)];
    return {
      animation: t$1
        ? `${h$1(a$1)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`
        : `${h$1(i$1)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`,
    };
  },
  N = import_react.memo(({ toast: e$1, position: t$1, style: o$1, children: s$1 }) => {
    let a$1 = e$1.height ? ke(e$1.position || t$1 || 'top-center', e$1.visible) : { opacity: 0 },
      i$1 = import_react.createElement($, { toast: e$1 }),
      r$1 = import_react.createElement(Ie, { ...e$1.ariaProps }, h(e$1.message, e$1));
...
var we = ({ id: e$1, className: t$1, style: o$1, onHeightUpdate: s$1, children: a$1 }) => {
    let i$1 = import_react.useCallback(
      (r$1) => {
        if (r$1) {
          let l$1 = () => {
          ...
          (l$1(),
            new MutationObserver(l$1).observe(r$1, {
              subtree: !0,
              childList: !0,
              characterData: !0,
            }));
  ...
  Me = (e$1, t$1) => {
    let o$1 = e$1.includes('top'),
      s$1 = o$1 ? { top: 0 } : { bottom: 0 },
      a$1 = e$1.includes('center')
...
`,
  ...
  Fe = ({
    reverseOrder: e$1,
    position: t$1 = 'top-center',
    toastOptions: o$1,
    gutter: s$1,
    children: a$1,
    toasterId: i$1,
    containerStyle: r$1,
    containerClassName: l$1,
  }) => {
    ...
    return import_react.createElement(
      ...
      g$1.map((d$1) => {
        let c$1 = d$1.position || t$1,
          p$1 = Me(
            c$1,
            T.calculateOffset(d$1, {
              reverseOrder: e$1,
              gutter: s$1,
              defaultPosition: t$1,
            })

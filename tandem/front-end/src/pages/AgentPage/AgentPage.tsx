...
export const AgentPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col overflow-hidden h-screen">
      {/* Chat Area */}
      <main className="flex-1 p-4 max-w-4xl mx-auto w-full flex flex-col gap-6 overflow-y-auto pt-24">

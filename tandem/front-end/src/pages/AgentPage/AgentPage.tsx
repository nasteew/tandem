...
export const AgentPage = () => {
  ...
  return (
    <div className="relative chat-page flex flex-col overflow-hidden w-full h-[calc(100vh-94px)] mt-[34px]  min-[481px]:mt-[24px] md:mt-[32px] md:h-[calc(100vh-112px)] max-[481px]:mt-[20px]">
      {interviewLevel === null ? (

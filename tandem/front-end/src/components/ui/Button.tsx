...
export const Button = ({ children, className = "", variant = "primary", size = "md", fullWidth = false, ...props }: ButtonProps) => {
  const baseStyles =
  ...
  const variants = {
    ...
    secondary: "bg-pink-600 text-white hover:bg-pink-700 focus:ring-pink-500 shadow-lg shadow-pink-500/30",
    outline: "border-2 border-slate-700 text-slate-200 hover:border-indigo-500 hover:text-indigo-400 bg-transparent",

        ...
        <div className="flex justify-center gap-4">
          {onRetry && (
            <Button
              ...
              shadow-[0_0_10px_var(--color-primary)] hover:shadow-[0_0_20px_var(--color-primary)]"
              variant="secondary"
            >
              Try Again
            </Button>

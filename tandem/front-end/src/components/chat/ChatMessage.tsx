    ...
    <div className={`flex gap-4 ${role === 'user' ? 'flex-row-reverse' : ''}`}>
      ...
      {role === 'assistant' ? (
        <Message className="bg-[var(--ai-blocks-color)] border-indigo-500/20 max-w-2xl">
          <div className="text-[var(--color-text-white)] leading-relaxed prose-sm">
            {content === '' ? (
        ...
        <div className="bg-[var(--color-primary)] rounded-xl p-4 max-w-2xl text-white shadow-lg shadow-indigo-500/10">

export const SectionCard = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="rounded-2xl p-6 backdrop-blur-xl border border-[var(--color-border-light)] shadow-xl transition-all duration-300 hover:shadow-[0_0_20px_rgb(96,165,250,0.6)] hover:bg-white/4 space-y-4">
